...
void ctrl_web_handle_login_get() {
  web_auth::handle_login_get(g_ctrl_web, g_cfg_ctrl_hostname.c_str());
}

void ctrl_web_handle_login_post() {
  web_auth::handle_login_post(g_ctrl_web, g_cfg_ctrl_hostname.c_str());
}

void ctrl_web_handle_logout_post() {
  web_auth::handle_logout_post(g_ctrl_web);
}
